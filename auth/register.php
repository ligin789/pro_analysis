      ...
      <div class="main-form">
        <form action="./authentication.php" method="POST">
          <div class="form-group d-flex">
            <input type="text" class="form-control custom-control1" id="firstname" aria-describedby="emailHelp" placeholder="First Name" name="firstname" />
            <input type="text" class="form-control custom-control1" id="lastname" aria-describedby="emailHelp" placeholder="Last Name" name="lastname" />
          </div>
          <div class="form-group d-flex">
            <input type="email" class="form-control custom-control1" id="email" aria-describedby="emailHelp" placeholder="Enter email" name="email" />
            <input type="number" class="form-control custom-control1" id="number" aria-describedby="emailHelp" placeholder="Enter Mobile" name="mobile" />
          </div>
          <div class="form-group d-flex">
            <input type="password" class="form-control custom-control1" id="pass" aria-describedby="emailHelp" placeholder="Enter Password" name="password" />
            <input type="password" class="form-control custom-control1" id="cpass" aria-describedby="emailHelp" placeholder="Enter Password Again" name="cpassword" />
          </div>
