      ...
      <ol class="breadcrumb">
		...
		<div class="box_general">
			...
			<div class="list_general">
				<ul>
                    <?php
                    $selectAllWebsite="SELECT * from tbl_website where website_status='1'";
                    $resultAllWebsite=mysqli_query($connect,$selectAllWebsite);
                    while($row=mysqli_fetch_array($resultAllWebsite))
                    {
                        ?>
                        <li>
						<span><?php echo ucwords($row['website_updated_at']);?></span>
						<h4><?php echo ucwords($row['website_name']);?> <i class="unread"><?php echo ucwords($row['website_created_at']);?></i></h4>
						<p><?php echo $row['website_domain'];?></p>
					</li>
                        <?php
                    }
                    ?>
